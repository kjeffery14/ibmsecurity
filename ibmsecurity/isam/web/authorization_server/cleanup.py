...
def get_all(isamAppliance, admin_pwd, admin_id="sec_master", domain="Default", check_mode=False, force=False):
    """
    Retrieving the list of authorization servers - parameters compatible with Ansible isam module.
    """
